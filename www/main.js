...
/* harmony import */ var _encoder__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../encoder */ "./api-flights/encoder.ts");
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../variables */ "./api-flights/variables.ts");
/* harmony import */ var _configuration__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../configuration */ "./api-flights/configuration.ts");
...
var FlightsService = /** @class */ (function () {
     ...
     */
    FlightsService.prototype.canConsumeForm = function (consumes) {
        var e_1, _a;
        var form = 'multipart/form-data';
        try {
            for (var consumes_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(consumes), consumes_1_1 = consumes_1.next(); !consumes_1_1.done; consumes_1_1 = consumes_1.next()) {
    ...
    FlightsService.prototype.getFlightOffers = function (originLocationCode, destinationLocationCode, departureDate, returnDate, adults, max, children, infants, travelClass, includedAirlineCodes, excludedAirlineCodes, nonStop, currencyCode, maxPrice, observe, reportProgress) {
    ...
    FlightsService.ɵfac = function FlightsService_Factory(t) { return new (t || FlightsService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_variables__WEBPACK_IMPORTED_MODULE_4__["BASE_PATH"], 8), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_configuration__WEBPACK_IMPORTED_MODULE_5__["Configuration"], 8)); };
    FlightsService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: FlightsService, factory: FlightsService.ɵfac });
    return FlightsService;
}());

/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](FlightsService, [{
...
var CustomHttpUrlEncodingCodec = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(CustomHttpUrlEncodingCodec, _super);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm5/http.js");
/* harmony import */ var _encoder__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../encoder */ "./api-locations/encoder.ts");
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../variables */ "./api-locations/variables.ts");
/* harmony import */ var _configuration__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../configuration */ "./api-locations/configuration.ts");
...
var LocationsService = /** @class */ (function () {
    ...
    LocationsService.prototype.getAirportCitySearch = function (subType, keyword, countryCode, pageLimit, pageOffset, sort, view, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var queryParameters = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]({ encoder: new _encoder__WEBPACK_IMPORTED_MODULE_3__["CustomHttpUrlEncodingCodec"]() });
        if (subType) {
            queryParameters = queryParameters.set('subType', subType.join(_variables__WEBPACK_IMPORTED_MODULE_4__["COLLECTION_FORMATS"]['csv']));
        }
    ...
    LocationsService.ɵfac = function LocationsService_Factory(t) { return new (t || LocationsService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_variables__WEBPACK_IMPORTED_MODULE_4__["BASE_PATH"], 8), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_configuration__WEBPACK_IMPORTED_MODULE_5__["Configuration"], 8)); };
    LocationsService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: LocationsService, factory: LocationsService.ɵfac });
    return LocationsService;
}());

/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LocationsService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }, { type: undefined, decorators: [{
                type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"]
            }, {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm5/http.js");
/* harmony import */ var _encoder__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../encoder */ "./api-safety/encoder.ts");
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../variables */ "./api-safety/variables.ts");
/* harmony import */ var _configuration__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../configuration */ "./api-safety/configuration.ts");
...
var SafetyService = /** @class */ (function () {
     ...
     * @return true: consumes contains 'multipart/form-data', false: otherwise
     */
    SafetyService.prototype.canConsumeForm = function (consumes) {
        var e_1, _a;
        var form = 'multipart/form-data';
        try {
            for (var consumes_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(consumes), consumes_1_1 = consumes_1.next(); !consumes_1_1.done; consumes_1_1 = consumes_1.next()) {
    ...
    SafetyService.prototype.getSafetyRanking = function (latitude, longitude, radius, pageLimit, pageOffset, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
    ...
    SafetyService.ɵfac = function SafetyService_Factory(t) { return new (t || SafetyService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_variables__WEBPACK_IMPORTED_MODULE_4__["BASE_PATH"], 8), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_configuration__WEBPACK_IMPORTED_MODULE_5__["Configuration"], 8)); };
    SafetyService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: SafetyService, factory: SafetyService.ɵfac });
    return SafetyService;
}());

/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](SafetyService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }, { type: undefined, decorators: [{
                type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"]
            }, {
...
var SecurityService = /** @class */ (function () {
    ...
    SecurityService.prototype.getAccessToken = function (grantType, clientId, clientSecret, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        if (useForm) {
            ...
            formParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]({ encoder: new _encoder__WEBPACK_IMPORTED_MODULE_3__["CustomHttpUrlEncodingCodec"]() });
        }
    ...
    SecurityService.ɵfac = function SecurityService_Factory(t) { return new (t || SecurityService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_variables__WEBPACK_IMPORTED_MODULE_4__["BASE_PATH"], 8), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_configuration__WEBPACK_IMPORTED_MODULE_5__["Configuration"], 8)); };
    SecurityService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: SecurityService, factory: SecurityService.ɵfac });
    return SecurityService;
}());

/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](SecurityService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }, { type: undefined, decorators: [{
                type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"]
            }, {
...
/* harmony import */ var _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/flex-layout/flex */ "./node_modules/@angular/flex-layout/__ivy_ngcc__/esm5/flex.es5.js");
...
/* harmony import */ var _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @angular/material/progress-spinner */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/progress-spinner.js");
...
/* harmony import */ var _angular_material_table__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @angular/material/table */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/table.js");
/* harmony import */ var _angular_flex_layout_extended__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @angular/flex-layout/extended */ "./node_modules/@angular/flex-layout/__ivy_ngcc__/esm5/extended.es5.js");
/* harmony import */ var _angular_material_divider__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @angular/material/divider */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/divider.js");
...
function AppComponent_button_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_button_4_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9); var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.openDatabaseDialog(); });
...
var _c0 = function () { return ["departure", "arrival", "duration", "departureAt", "arrivalAt"]; };
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.openSettingsDialog = function () {
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result == undefined) {
                ...
                _this.amadeusApi.verifyApiCredentials(result.credentials.key, result.credentials.secret);
                _this.resetParams(result.local);
                _this.databaseApi.verifyDbLogs(result.logs);
            }
        });
    };
    // opening database modal window
    AppComponent.prototype.openDatabaseDialog = function () {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result == undefined) {
                ...
                // syncing updates from settings dialog
                _this.databaseApi.verifyDbCredentials(result.credentials.key, result.credentials.secret);
            }
        });
    };
    // color coding safety scores 
    AppComponent.prototype.applyCSSClass = function (spec, value) {
        var prefix = '';
        if (spec == 'text')
            prefix = 'score-';
        if (spec == 'border')
    ...
    AppComponent.prototype.checkRiskLevel = function (value) {
        if (value <= 33)
            return 'Low risk';
        if (value > 33 && value <= 66)
            return 'Average risk';
    ...
    AppComponent.prototype.resetParams = function (value) {
        var newValue = value;
        if (newValue == null) {
    ...
    AppComponent.prototype.validateQuery = function () {
    ...
    AppComponent.prototype.formatAirlines = function (airlineCodes, carriers) {
        var airlinesList = [];
        airlineCodes.forEach(function (airline) { return airlinesList.push(carriers[airline]); });
        return airlinesList.toString();
    };
    // initiate search for flights
    AppComponent.prototype.initiateSearch = function () {
        var _this = this;
        ...
        this.amadeusApi.getLocationDetails(this.flightsQuery.originLocationCode).subscribe(function (originLocation) {
            ...
            _this.flightsQuery.originLocationCode = originLocation.data[0].iataCode;
            // STEP 2 - transform destination city name into IATA code using Amadeus location API
            _this.amadeusApi.getLocationDetails(_this.flightsQuery.destinationLocationCode).subscribe(function (destinationLocation) {
                console.debug('-- received destination location details', destinationLocation);
                _this.locationData = destinationLocation.data[0];
                _this.flightsQuery.destinationLocationCode = _this.locationData.iataCode;
                // STEP 3 - search for flight offers using obtained location IATA codes and dates provided by user
                _this.amadeusApi.searchFlights(_this.flightsQuery).subscribe(function (flightsData) {
                    _this.flightsOffers = flightsData.data;
                    _this.flightsDictionaries = flightsData.dictionaries;
                    ...
                    _this.amadeusApi.getSafetyDetails(_this.locationData.geoCode.latitude, _this.locationData.geoCode.longitude).subscribe(function (safetyData) {
                        console.debug('-- received safety data', safetyData);
                        if (safetyData.data.length > 0) {
                            _this.safetyScore = safetyData.data[0].safetyScores;
                        }
                        else {
                            _this.foundSafetyData = false;
                        }
                    });
                    // STEP 5 (OPTIONAL) - log query in DB
                    if (_this.databaseApi.verifyDbLogs()) {
                        _this.databaseApi.submitData(_this.flightsQuery).subscribe(function (res) {
...
/* harmony import */ var _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @angular/material/progress-bar */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/progress-bar.js");
...
/* harmony import */ var _angular_material_divider__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @angular/material/divider */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/divider.js");
/* harmony import */ var _angular_material_badge__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @angular/material/badge */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/badge.js");
/* harmony import */ var _angular_material_table__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @angular/material/table */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/table.js");
/* harmony import */ var _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! @angular/material/grid-list */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/grid-list.js");
...
var OauthInterceptor = /** @class */ (function () {
    ...
    OauthInterceptor.prototype.intercept = function (request, next) {
...
/* harmony import */ var _angular_material_table__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/material/table */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/table.js");
...
var _c0 = function () { return ["timestamp", "departure", "arrival", "departure_date", "return_date"]; };
...
var DatabaseDialog = /** @class */ (function () {
    ...
    DatabaseDialog.prototype.ngOnInit = function () {
        this.loadLogs();
    };
...
var MomentPipe = /** @class */ (function () {
    ...
    MomentPipe.prototype.transform = function (date, type, format) {
...
var AlertService = /** @class */ (function () {
    ...
    AlertService.prototype.showAlert = function (message) {
        var _this = this;
        // NgZone workaround required to avoid showing alert twice 
        this.zone.run(function () {
            _this.alertBar.open(message);
...
var AmadeusService = /** @class */ (function () {
    ...
    AmadeusService.prototype.verifyRunningLocal = function (value) {
    ...
    AmadeusService.prototype.verifyApiCredentials = function (api_key, api_secret) {
    ...
    AmadeusService.prototype.obtainToken = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.securityApi.getAccessToken('client_credentials', _this.apiCredentials.key, _this.apiCredentials.secret).subscribe(function (value) {
    ...
    AmadeusService.prototype.provideToken = function () {
        var _this = this;
        return rxjs_Observable__WEBPACK_IMPORTED_MODULE_1__["Observable"].fromPromise(new Promise(function (resolve, reject) {
            if (_this.accessToken) {
                ...
                _this.obtainToken().then(function (value) {
                    _this.accessToken = value.access_token;
    ...
    AmadeusService.prototype.searchFlights = function (flightsQuery) {
    ...
    AmadeusService.prototype.getLocationDetails = function (cityName) {
    ...
    AmadeusService.prototype.getSafetyDetails = function (lat, long) {
...
var DatabaseService = /** @class */ (function () {
    ...
    // function to update or just provide a status of running local param
    DatabaseService.prototype.verifyDbLogs = function (value) {
        if (value !== null && value !== undefined) {
            this.dbLogs = value;
            return this.dbLogs;
        }
    ...
    // function to update or just provide credentials to Amadeus APIs
    DatabaseService.prototype.verifyDbCredentials = function (user_key, user_secret) {
    ...
    DatabaseService.prototype.getHttpOptions = function (setType) {
    ...
    DatabaseService.prototype.loadData = function () {
        return this.http.get('/database/getData', this.getHttpOptions());
    };
    // function to submit log to database
    DatabaseService.prototype.submitData = function (data) {
    ...
    DatabaseService.prototype.removeData = function () {
